...
export default function PvPTimedScreen(): JSX.Element {
  ...
  const [player2Choice, setPlayer2Choice] = useState<(keyof typeof iconSources) | null>(null);
  ...
  const handleChoice = (choice: keyof typeof iconSources) => {
    if (sequenceRunning || gameOver) return;
    if (isPlayer1Turn) {
          ...
          <View style={styles.choicesContainer}>
            ...
            <View style={styles.playerContainer}>
              {player2Choice ? (
                <>
                  <Image
                    source={player2Choice ? iconSources[player2Choice] : undefined}
                    style={styles.choiceImage}
                    resizeMode="contain"
                  />
